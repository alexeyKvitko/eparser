package tech.madest.eparser.entity.shopizer.product.image;
...
//@SequenceGenerator(name = "description_gen", sequenceName = "product_image_description_seq", allocationSize = SchemaConstant.DESCRIPTION_ID_SEQUENCE_START)
